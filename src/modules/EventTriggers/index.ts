...
export const triggers = {
  ...
  recordShow: [Detail + Show, Create + Show, Edit + Show],
  credit: {
    show: [Create + Show, Edit + Show],
    change: (fieldCds: string | string[]) => createMap(Create, fieldCds).concat(createMap(Edit, fieldCds)),
    submit: [Create + Submit, Edit + Submit],
    success: [Create + Success, Edit + Success],
  },
}
